...
router.get('/sitemap', async (_, res) => {
  ...
  result += '<url><loc>http://localhost:3000</loc></url>';
  result += '<url><loc>http://localhost:3000/explore</loc></url>';
  result += '<url><loc>http://localhost:3000/collections</loc></url>';

  tokens.map(v => {
    result += '<url><loc>http://localhost:3000/collection/' + v.contractAddress + '/' + v.tokenID + '</loc></url>';
  });
  ...
  allCollections.map(v => {
    result += '<url><loc>http://localhost:3000/collection/' + v.erc721Address + '</loc></url>';
  });
  result += "</urlset>";
