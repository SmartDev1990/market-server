...
console.log('do return');
  ...
  <meta property="og:url" content="http://localhost:3000/collection/${address}/${tokenid}" />
  <meta property="twitter:image" content="${token.imageURL}" />
  </head>
  <body>
  <meta http-equiv="refresh" content="0; url=http://localhost:3000/collection/${address}/${tokenid}" />
  </body>
  </html>`);
});
