...
router.post('/getCollectionStatistic', async (req, res) => {
  ...
  console.log('Validasi alamat kontrak: ' + address);
  if (!ethers.utils.isAddress(address)) {
    console.log('Alamat kontrak tidak valid: ' + address);
    return res.json({
      status: 'failed',
      data: 'Invalid NFT Contract Address. Please provide a valid Ethereum address.'
    });
  }
